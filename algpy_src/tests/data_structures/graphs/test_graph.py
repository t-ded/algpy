...
# TODO: In the future, probably migrate this to be tests for respective adjacency matrix/adjacency list simple digraph subclasses
class TestDirectedSimpleGraph:
    ...
    def test_directed_simple_graph_base(self, simple_digraph: ExampleDirectedSimpleGraph) -> None:
        ...
        assert simple_digraph.space_complexity == 'N/A'
        ...
        assert simple_digraph.adjacency_list == {'ExampleNodeA': {'ExampleNodeB': 1}}
        assert simple_digraph.adjacency_matrix == [[1, 0], [0, 0]]
